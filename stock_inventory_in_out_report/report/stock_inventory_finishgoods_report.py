...
report_sxw.report_sxw('report.stock.inventory.finish.goods.webkit', 'stock.inventory.finish.goods.wizard', 'addons/stock_inventory_in_out_report/report/stock_inventory_finishgoods_report.mako', parser=stock_inventory_finishgood_report,header=False)
