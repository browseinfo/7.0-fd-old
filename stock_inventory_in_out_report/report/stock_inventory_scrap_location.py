...
report_sxw.report_sxw('report.stock.inventory.scrap.location.webkit', 'stock.inventory.scrap.location.wizard', 'addons/stock_inventory_in_out_report/report/stock_inventory_scrap_location.mako', parser=stock_inventory_scrap_location_report,header=False)
