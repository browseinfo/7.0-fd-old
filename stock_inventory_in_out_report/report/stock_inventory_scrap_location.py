...
class stock_inventory_scrap_location_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(stock_inventory_scrap_location_report, self).__init__(cr, uid, name, context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(stock_inventory_scrap_location_report, self).set_context(objects, data, ids, report_type=report_type)
...
report_sxw.report_sxw('report.stock.inventory.scrap.location.webkit', 'stock.inventory.scrap.location.wizard', 'addons/stock_inventory_in_out_report/report/stock_inventory_scrap_location.rml', parser=stock_inventory_scrap_location_report,header="internal landscape")
