...
class stock_inventory_rawmaterial_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(stock_inventory_rawmaterial_report, self).__init__(cr, uid, name, context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(stock_inventory_rawmaterial_report, self).set_context(objects, data, ids, report_type=report_type)
