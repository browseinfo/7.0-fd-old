...
<body>
    ...
    %for o in objects :
        <table width="100%">
                <tr>
                    <th style="text-align:center; border:1px solid black;">  ${_("NO")}</th>
                    <th style="text-align:center; border:1px solid black;"> ${_("CUSTOMER")}</th>
                    <th style="text-align:center; border:1px solid black;"> ${_("TOTAL (USD)")}</th>
